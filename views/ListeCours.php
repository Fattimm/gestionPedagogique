...
<body class="bg-blue-50 flex">
    ...
    <aside class="w-64 bg-blue-900 text-white min-h-screen">
        ...
        <nav class="mt-6">
            <ul>
                ...
                <li class="p-4 hover:bg-gray-700">
                    <a href="/ListeSessionsCours" class="flex items-center space-x-2">
    ...
    <div class="flex-1 p-6">
        ...
        <div>
            ...
            <!-- Filter Form -->
            <form class="mb-6" method="get" action="/ListeCours">
                <div class="max-w-lg mx-0">
                    <div class="flex items-start gap-4">
                        <!-- Filtrage par semestre -->
                        <div class="flex flex-col w-1/4">
                            <label for="semestre" class="text-gray-700 font-medium">Semestre:</label>
                            <select id="semestre" name="semestre" class="w-full bg-white border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Tous les Semestres</option>
                                <?php foreach ($semestres as $semestre) : ?>
                                    <option value="<?php echo htmlspecialchars($semestre['Semestre']); ?>" <?php echo isset($_GET['semestre']) && $_GET['semestre'] == $semestre['Semestre'] ? 'selected' : ''; ?>>
                        ...
                        <div class="flex flex-col w-1/4">
                            ...
                            <select id="module" name="module" class="w-full bg-white border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <?php foreach ($modules as $module) : ?>
                                    <option value="<?php echo htmlspecialchars($module['Module']); ?>" <?php echo isset($_GET['module']) && $_GET['module'] == $module['Module'] ? 'selected' : ''; ?>>
                        ...
                        <!-- Filtrage par année -->
                        <div class="flex flex-col w-1/4">
                            <label for="annee" class="text-gray-700 font-medium">Année</label>
                            <select id="annee" name="annee" class="w-full bg-white border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Année en Cours</option>
                                <?php foreach ($annees as $annee) : ?>
                                    <option value="<?php echo htmlspecialchars($annee['AnneeScolaire']); ?>" <?php echo isset($_GET['annee']) && $_GET['annee'] == $annee['AnneeScolaire'] ? 'selected' : ''; ?>>
                                        <?php echo htmlspecialchars($annee['AnneeScolaire']); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <?php foreach ($cours as $course) : ?>
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    <span class="<?php echo $course['status'] === 'Terminé' ? 'text-green-500' : 'text-red-500'; ?>">
